...
public class FTC201718_Actuators_Setup
{
    ...
    */
    ...
    public static final double COUNTS_PER_ANGLE     = 2200.0/90.0;  // to be calibrated empircally
    public static final double COUNTS_PER_ASIDE     = 180.0;        // to be calibrated empircally
